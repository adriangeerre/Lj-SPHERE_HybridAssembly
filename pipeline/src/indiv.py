...
def init(read1, read2, long, prefix, threads):
    ...
    # QC
    qc.qc_illumina(illumina_1=read1, illumina_2=read2, out_dir=f"01-QC/{prefix}/Illumina", threads=threads, prefix=prefix)
    qc.qc_nanopore(nanopore=long, out_dir=f"01-QC/{prefix}", threads=threads)
    pass
